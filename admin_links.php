...
<form method="get" action="admin.php?page=linkdir_links" name="linkdir">
	...
	?>
<?php if(isset($ready)){if(mysql_num_rows($query)){ ?><p><input type="submit" name="submit" value="Delete Selected" class="button-primary" onClick="return confirm('Do you really want to delete all selected links? There is no undo!')" /></p></form><?php }} ?>
</div>
