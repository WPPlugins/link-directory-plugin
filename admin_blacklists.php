...
<?php if(isset($saved)): ?><div class="saved">Blacklist has been updated. Please note that the settings apply only to new links - that means existing links will not be deleted.</div><?php endif; ?>
